...
class Increment {
	private int num1 = 0; //일반 멤버변수
	public static int num2 = 0; //클래스 변수 (정적변수) : 고정변수. 객체들끼리 공유함!
...
public class StaticTest {
	public static void main(String[] args) {
		 ...
		 *  - 싱글톤 객체를 사용해 메모리 절약과 성능 향상을 기대
		 *  - 외부 생성을 막기 위해 private 생성자 선언
		 */
		
		
		// 여러 개의 객체를 생성할 필요가 없는 객체
		// 속성이 없고 기능만 있기 때문에!
		/*
		Calc cal = new Calc();
